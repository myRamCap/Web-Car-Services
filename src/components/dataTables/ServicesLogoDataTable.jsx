...
export default function ServicesLogoDataTable() {
  const [showModal, setShowModal] = useState(false)
  const paginationAlignment = useState("center")
  
  const columns = [
    { field: "Name", title: "Name", width: 100, render: (rowData) => {
  ...
  return (
    <div>
      <MaterialTable
        ...
        options={options}
      />
      <ServicesLogoDataTable show={showModal} close={() => setShowModal(false)} id={1}/>
    </div>
  )
}
